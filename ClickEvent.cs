...
public partial class ClickEvent : Node2D
{
    bool click_all = false;
    bool ignore_unclickable = true;

    public override void _Input(InputEvent @event)
    {
        // if(@event is InputEventMouseButton mouseButton){
        //     if(mouseButton.Pressed && mouseButton.ButtonIndex==MouseButton.Left){
        //         GetTree().Root.GetViewport().World2D.DirectSpaceState.IntersectPoint(GetGlobalMousePosition())
        //     }
        // }
    }
}
